...
const features = [
  ...
  { number: "03", title: "Put history in perspective.", description: "Angles are the situations behind this week’s matchups—how a team, coach or quarterback has actually done in spots like this one, with sample sizes and limits in view.", tag: "SPOT STATS", href: "/stats", label: "Explore Angles" },
];
    ...
    <div className={styles.page}>
      ...
      <main id="main">
        ...
        <section id="pricing" className={styles.section}>
          <div className={styles.sectionHeading}><p className={styles.eyebrow}>CHOOSE YOUR DEPTH</p><h2>Start with the market.<br />Go deeper when you’re ready.</h2><p>The market board, game briefs, and one featured matchup of Signals and Angles are free every week.<br />Surf Pro opens the whole slate.</p></div>
        ...
        <section className={styles.faq} aria-labelledby="faq-title"><div><p className={styles.eyebrow}>GOOD QUESTIONS</p><h2 id="faq-title">Before you<br />dive in.</h2></div><div>{[
          ...
          ["What does Surf Pro add?", "Surf Pro is $9.99 per month and unlocks Signals and Angles for every matchup. Without it you still get the market board, game briefs, and one featured matchup of each every week. Check your account for availability."],
