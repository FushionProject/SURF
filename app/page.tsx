...
const features = [
  ...
  { number: "03", title: "Put history in perspective.", description: "Trends are the situations behind this week’s matchups—how a team, coach or quarterback has actually done in spots like this one, with sample sizes and limits in view.", tag: "TRENDS", href: "/stats", label: "Explore Trends" },
];
    ...
    <div className={styles.page}>
      ...
      <main id="main">
        ...
        <section className={styles.faq} aria-labelledby="faq-title"><div><p className={styles.eyebrow}>GOOD QUESTIONS</p><h2 id="faq-title">Before you<br />dive in.</h2></div><div>{[
          ...
          ["What does Surf Pro add?", "Surf Pro is $9.99 per month and unlocks Signals and Trends for every matchup. Without it you still get the market board, game briefs, and one featured matchup of each every week. Check your account for availability."],
