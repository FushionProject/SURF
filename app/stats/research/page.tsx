...
export default async function LocalStatsPage({ searchParams }: { searchParams: Promise<PreviewParams> }) {
  ...
  return <div className={styles.page}>
    <main className={styles.shell}>
      ...
      <form action="/stats/research" className={styles.controls}>
      ...
      {issue ? <section className={styles.notice} role="alert"><h2>Results paused</h2><p>{issue}</p><Link href="/stats/research" prefetch={false}>Reset filters</Link></section> : null}
      {result && preview ? <>
