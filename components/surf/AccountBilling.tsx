    ...
    <section className="mt-5 border border-[color:var(--surf-primary)]/35 bg-[color:var(--surf-surface)] p-5" aria-labelledby="surf-billing-title">
      ...
      {status?.available && (plan || status.canManage) ? (
        <>
          ...
          {canBuyPro ? <p className="mt-3 text-sm leading-6 text-[color:var(--surf-ink-70)]">Surf Pro unlocks Signals and Trends for every matchup. One featured matchup of each stays free every week.</p> : null}
