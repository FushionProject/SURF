...
const kalshiEnabled = process.env.SURF_KALSHI_ENABLED;
const polymarketEnabled = process.env.SURF_POLYMARKET_ENABLED;
const threshold = process.env.SURF_PREDICTION_WHALE_THRESHOLD_USD;
process.env.SURF_PREDICTION_MARKETS_ENABLED = "true";
process.env.SURF_KALSHI_ENABLED = "true";
process.env.SURF_POLYMARKET_ENABLED = "true";
...
try {
  ...
  if (kalshiEnabled === undefined) delete process.env.SURF_KALSHI_ENABLED;
  else process.env.SURF_KALSHI_ENABLED = kalshiEnabled;
  if (polymarketEnabled === undefined) delete process.env.SURF_POLYMARKET_ENABLED;
  else process.env.SURF_POLYMARKET_ENABLED = polymarketEnabled;
