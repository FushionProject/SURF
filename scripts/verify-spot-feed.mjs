...
import { buildSpotFeed } from "../lib/spot-stats/spot-feed.ts";
...
console.log("Spot feed tests passed: grading, missing lines, fixed situations, verified coach scope, international membership, staleness, kickoff, duplicates, aliases, no outcome ranking, and local guards.");
