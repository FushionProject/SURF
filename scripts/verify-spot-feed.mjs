...
const nightTotal = card(nightFeed,"coach-night-totals");
...
assert.equal(card(build([...nights.map((r,i)=>i===0?{...r,total_line:""}:r),{...venueCurrent,gametime:"20:15"}]),"coach-night-totals").prominence,null,"missing totals cannot become selected highlights");
