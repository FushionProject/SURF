...
const suites = [
  ...
  "test:paid-access", "test:comp-access", "test:spot-stats:preview", "test:spot-stats:feed", "test:spot-research", "test:spot-stats:published", "test:spot-research-postgres", "test:spot-research-refresh",
