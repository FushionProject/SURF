...
try {
  ...
  await page.locator('.bn-masthead').getByRole('link', { name: 'Spot Stats', exact: true }).click();
  ...
  assert.equal(await page.getByRole('heading', { name: 'Spot Stats', exact: true }).count(), 1);
