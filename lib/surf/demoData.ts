...
export function getDemoSurfFeed(dataSource: SurfDataSource) {
  const signals: SignalCard[] = [
    signal({
      id: "demo-total-major-move",
      gameId: "demo-mlb-sea-nyy",
      signalType: "Market Movement",
      market: "totals",
      title: "Meaningful total move",
      detail: "Total: 8.0 → 9.5",
      insight: DEMO_NOTICE,
      lineMovement: 1.5,
      strengthScore: 88,
    }),
    signal({
      id: "demo-moneyline-shift",
      gameId: "demo-mlb-bos-tor",
      signalType: "Market Movement",
      title: "Favorite drawing support",
      detail: "Moneyline: -125 → -165",
      insight: DEMO_NOTICE,
      lineMovement: 40,
      strengthScore: 86,
    }),
    signal({
      id: "demo-wide-book-split",
      gameId: "demo-mlb-lad-sf",
      signalType: "Book Disagreement",
      market: "totals",
      title: "Books split on the total",
      detail: "Total: 7.5 vs 9.0",
      insight: DEMO_NOTICE,
      gap: 1.5,
      strengthScore: 84,
      sources: [
        { label: "Low", book: "DraftKings", value: "7.5" },
        { label: "High", book: "Caesars", value: "9.0" },
      ],
    }),
    signal({
      id: "demo-stale-run-line",
      gameId: "demo-mlb-chc-stl",
      signalType: "Stale Book",
      market: "spreads",
      title: "One book is still off market",
      detail: "Run line: +1.0 vs +1.5",
      insight: DEMO_NOTICE,
      strengthScore: 76,
      sources: [
        { label: "Market", book: "5-book consensus", value: "+1.0" },
        { label: "Stale", book: "Fanatics", value: "+1.5" },
      ],
    }),
    signal({
      id: "demo-total-standard-move",
      gameId: "demo-mlb-atl-nym",
      signalType: "Line Movement",
      market: "totals",
      title: "Total ticked upward",
      detail: "Total: 8.0 → 8.5",
      insight: DEMO_NOTICE,
      lineMovement: 0.5,
      strengthScore: 52,
    }),
    signal({
      id: "demo-run-line-move",
      gameId: "demo-mlb-hou-tex",
      signalType: "Market Movement",
      market: "spreads",
      title: "Run line tightened",
      detail: "Run line: +1.5 → +1.0",
      insight: DEMO_NOTICE,
      lineMovement: 0.5,
      strengthScore: 47,
    }),
    signal({
      id: "demo-best-number",
      gameId: "demo-mlb-cle-det",
      signalType: "Best Number",
      market: "spreads",
      title: "Best number still available",
      detail: "Market: +1.0 vs +1.5",
      insight: DEMO_NOTICE,
      gap: 0.5,
      strengthScore: 44,
      sources: [
        { label: "Best", book: "bet365", value: "+1.5" },
        { label: "Market", book: "Consensus", value: "+1.0" },
      ],
    }),
    signal({
      id: "demo-moderate-book-split",
      gameId: "demo-mlb-sd-ari",
      signalType: "Book Disagreement",
      market: "totals",
      title: "Books have not fully aligned",
      detail: "Total: 7.5 vs 8.5",
      insight: DEMO_NOTICE,
      gap: 1,
      strengthScore: 36,
      sources: [
        { label: "Low", book: "BetMGM", value: "7.5" },
        { label: "High", book: "FanDuel", value: "8.5" },
      ],
    }),
    signal({
      id: "demo-quiet-market",
      gameId: "demo-mlb-sd-ari",
      signalType: "Market Movement",
      market: "totals",
      title: "Market holding steady",
      detail: "Total: 8.0 → 8.0",
      insight: DEMO_NOTICE,
      lineMovement: 0,
      strengthScore: 18,
    }),
