...
export function getDemoSurfFeed(dataSource: SurfDataSource) {
  ...
  signals.splice(
    ...
    signal({
      id: "demo-best-price",
      gameId: "demo-mlb-sea-nyy",
      signalType: "Best Price",
      market: "totals",
      title: "Best Over price: -102",
      detail: "bet365 8.5 (-102)",
      insight: "The same 8.5 total is meaningfully cheaper here than the median price across the sampled books.",
      sources: [
        { label: "Available now", book: "bet365", value: "8.5 (-102)" },
        { label: "Market consensus", book: "6 books", value: "8.5 (-118)" },
      ],
      valueOptions: [{ selection: "Over", book: "bet365", line: "8.5", price: "-102" }],
      detectedAt: now - 9 * 60_000,
      signalChangedAt: now - 9 * 60_000,
      lastSeenAt: now,
      strengthScore: 84,
      opportunity: {
        kind: "best_price",
        score: 84,
        reason: "The same number is about 3.9 implied-probability points cheaper than the median price.",
        selection: "Over",
        bookTitle: "bet365",
        point: 8.5,
        price: -102,
    ...
    signal({
      ...
      market: "totals",
      title: "Best Over number: 7.5",
      detail: "DraftKings 7.5 (-110)",
      insight: "This is 1 point lower than the market consensus for the same Over selection.",
      sources: [
        { label: "Available now", book: "DraftKings", value: "7.5 (-110)" },
        { label: "Market consensus", book: "6 books", value: "8.5" },
      ],
      valueOptions: [{ selection: "Over", book: "DraftKings", line: "7.5", price: "-110" }],
      detectedAt: now - 21 * 60_000,
      signalChangedAt: now - 21 * 60_000,
      lastSeenAt: now,
      strengthScore: 80,
      opportunity: {
        kind: "best_line",
        score: 80,
        reason: "This is 1 point better than the market consensus.",
        selection: "Over",
